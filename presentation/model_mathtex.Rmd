...
$$
\begin{aligned}
& Y_i = \beta_0 + \beta_1 x_{1i} + \beta_1 x_{2i} + \beta_3 x_{3i} + \beta_4 + \beta_4 x_{4i}  + \epsilon_i,\ \text{where we assumed, } \epsilon_i \sim \mathbb{N}(0,\sigma_{Y}^2) \\
&\\
...
& \\
& Y_i = \hat{\beta_0} + \hat{\beta_1} x_{1i} + \hat{\beta_1} x_{2i} + \hat{\beta_3} x_{3i} + \hat{\beta_4} + \hat{\beta_4} x_{4i} \\
& \\
& \text{where, } \\
& \\
